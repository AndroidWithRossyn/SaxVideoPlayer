...
import com.hammerapp.sx.xxplayer.adapter.PrivateAdapter;
import com.hammerapp.sx.xxplayer.adapter.PrivateGridAdapter;
...
public class UnLockFileActivity extends AppCompatActivity implements PrivateAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(this).show_BANNER((ViewGroup) native_ads, ADMOB_B1, FACEBOOK_B1,MOPUB_B1,this);
