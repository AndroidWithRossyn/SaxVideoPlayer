...
import com.hammerapp.sx.xxplayer.adapter.NavigationMenuAdapter;
import com.hammerapp.sx.xxplayer.comman.ModelMenu;
import com.hammerapp.sx.xxplayer.comman.NavigationClickListener;
...
import com.hammerapp.sx.xxplayer.fragement.WhateAppStatusFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        folder_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppManage.getInstance(MainActivity.this).show_INTERSTIAL(MainActivity.this, new AppManage.MyCallback() {
    ...
    public void nevigationMenu() {
        ...
        modelMenus.add(new ModelMenu("Policy", R.drawable.ic_privacy_policy));
