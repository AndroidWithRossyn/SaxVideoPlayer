...
import com.hammerapp.sx.xxplayer.activity.SpecificVideoActivity;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (holder.getItemViewType()) {
            ...
            case 2:
                ...
                AppManage.getInstance(context).show_BANNER((ViewGroup) holderds.banner_ads, ADMOB_B1, FACEBOOK_B1,MOPUB_B1,context);
                break;
        }
