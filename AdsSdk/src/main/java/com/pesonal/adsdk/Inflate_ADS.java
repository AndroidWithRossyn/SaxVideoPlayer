...
public class Inflate_ADS {
    ...
    public void inflate_NATIV_ADMOB(UnifiedNativeAd nativeAd, ViewGroup cardView) {
        ...
        UnifiedNativeAdView adView = view.findViewById(R.id.uadview);
    ...
    public void inflate_Half_NATIV_ADMOB(UnifiedNativeAd nativeAd, ViewGroup cardView) {

        cardView.setVisibility(View.VISIBLE);
        LayoutInflater inflater = LayoutInflater.from(activity);
        View view = (View) inflater
                .inflate(R.layout.ads_nativ_half_admob, null);
        cardView.removeAllViews();
        cardView.addView(view);
    ...
    public void inflate_NATIV_half_FB(NativeAd nativeAd, ViewGroup card) {

        card.setVisibility(View.VISIBLE);
        nativeAd.unregisterView();
        LayoutInflater inflater = LayoutInflater.from(activity);
        View adView = inflater.inflate(R.layout.ads_nativ_half_fb, null);
